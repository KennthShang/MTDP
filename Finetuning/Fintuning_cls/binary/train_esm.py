...
def return_metric(test_loader):
    ...
    return balanced_accuracy_score(y_true, y_pred), f1_score(y_true, y_pred, average='macro')
...
pkl.dump(eval_F1, open(f'{inputs.outpth}/esm_F1.pkl', 'wb'))
pkl.dump(eval_acc, open(f'{inputs.outpth}/esm_acc.pkl', 'wb'))
